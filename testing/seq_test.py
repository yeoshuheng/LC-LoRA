...
def main():
    ...
    SAVE_LOC = HDFP + "/lobranch-snapshot/lobranch"
    SAVE_LOC_FULL = HDFP + "/lobranch-snapshot/full"
    ...
    for epch in range(1):
        for i, data in enumerate(train_loader, 0):
            ...
            if current_iter != 0 and current_iter % 2 == 0:
    ...
    write_path = HDFP + "/lobranch-snapshot/full_acc_results.json"
